...
<svelte:head>
    <title>KekOnTheWorld | Imprint</title>
</svelte:head>
...
<div class="wrapper" class:mount id="about">
    ...
    <main class="full">
        ...
        <section>
            ...
            <p>Eine detaillierte version, welche Daten wir verarbeiten, finden sie in <a href="https://legal.kotw.dev/de/privacy" target="_blank">unserer Datenschutzerklärung</a>.</p>
